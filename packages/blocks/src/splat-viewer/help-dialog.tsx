                ...
                {mode === 'orbit' ? (
                    <ControlSection
                        controls={[
                            ...
                            [
                                'Reset View',
                                <div className="flex gap-2 text-right" key="reset">
                    ...
                    <ControlSection
                        controls={[
                            ...
                            [
                                'Forward / Backward',
                                <div className="flex gap-2" key="forward-backward">
                            ...
                            [
                                'Left / Right',
                                <div className="flex gap-2" key="left-right">
                            ...
                            [
                                'Up / Down',
                                <div className="flex gap-2" key="up-down">
                            ...
                            [
                                'Reset View',
                                <div className="flex gap-2" key="reset">
                                    <Badge variant="secondary">R</Badge>
                                </div>
                            ]
                        ]}
                ...
                <DialogContent className="max-w-md" aria-label="Camera Controls">
                    ...
                    <Tabs defaultValue="keyboard">
                        <TabsList className="grid w-full grid-cols-2">
                            <TabsTrigger value="keyboard" className="data-[state=active]:bg-background">
                                Keyboard
                            </TabsTrigger>
                            <TabsTrigger value="touch" className="data-[state=active]:bg-background">
                                Touch
                            </TabsTrigger>
                        </TabsList>
                        <CameraHelpTable />
