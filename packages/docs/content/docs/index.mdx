...
<div className="flex flex-row gap-6 my-2 mt-6 items-center">
  <a className="group shadow flex items-center -ml-2 flex-row gap-2 bg-muted rounded-full p-2 px-4 max-w-fit transition-colors duration-150" href="/docs#getting-started">
  ...
  <a className="text-xs underline duration-150 text-muted-foreground font-medium" href="/docs#why-playcanvas-react">
    Learn more
  </a>
</div>

<div className='lg:w-[calc(100%+4rem)] aspect-video rounded-xl overflow-hidden mt-8 lg:-mx-8'>
  <ReactQueryProvider>
...
<div className="flex flex-row gap-6 my-4 -mt-12 justify-end pr-8 lg:pr-0">
