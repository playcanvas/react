...
<a className="flex items-center mb-8 mt-4 -ml-2 flex-row gap-2 bg-zinc-800 rounded-full p-2 px-4 max-w-fit" href="/docs/guide/getting-started">
...
<div className="outline p-28 mt-12 mb-0 rounded-t-lg bg-linear-to-br from-violet-600 to-purple-600 relative">
  ...
  <SplatViewer src='./skull.compressed.ply' type='animation' className="bg-purple-200 rounded-lg shadow-xl cursor-grab active:cursor-grabbing" >
