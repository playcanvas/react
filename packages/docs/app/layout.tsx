...
export default async function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang="en" dir="ltr" suppressHydrationWarning>
      ...
      <body>
        <Layout
          banner={<Banner storageKey="0.8.0-release"><a href="https://github.com/playcanvas/react/releases/tag/v0.8.0" target="_blank" rel="noreferrer">
            🎉 <b>@playcanvas/react 0.8.0</b> is here! ✨ 
          </a></Banner>}
          navbar={navbar}
          footer={<Footer>
