...
export const Example = () => {
    ...
    return (<Entity>
        ...
        <div className="pointer-events-none absolute inset-50 transition-opacity duration-500 " style={{
            opacity: hovered ? 1 : 0
        }}>
            <div className="absolute inset-0 bg-gradient-to-tr from-purple-500 via-pink-500 to-orange-500 blur-[100px] opacity-80" />
        </div>
