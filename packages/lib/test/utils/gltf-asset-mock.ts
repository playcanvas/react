import type { Entity as PcEntity, Asset } from 'playcanvas';
 ...
 */
export function createMockGltfAsset(hierarchy: PcEntity, id: number = Math.floor(Math.random() * 1000000)): Asset {
