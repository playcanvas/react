...
import type { AssetMeta } from '../utils/fetch-asset.ts';
import { fetchAsset } from '../utils/fetch-asset.ts';
 ...
 */
// eslint-disable-next-line @typescript-eslint/consistent-type-definitions -- preserve the public hook result declaration
 ...
 * ```
 */
export const useAsset = (src: string, type: string, props: Record<string, unknown> = {}): AssetResult => {
    const app = useApp();
    ...
    useEffect(() => {
        ...
        // eslint-disable-next-line react-hooks/set-state-in-effect -- changing inputs resets the asynchronous load state
        setResult({
            asset: null,
            loading: true,
            error: null
 ...
 * ```
 */
export const useSplat = (src: string, props: Record<string, unknown> = {}): AssetResult =>
 ...
 * ```
 */
export const useTexture = (src: string, props: Record<string, unknown> = {}): AssetResult =>
 ...
 * ```
 */
export const useEnvAtlas = (src: string, props: Record<string, unknown> = {}): AssetResult =>
 ...
 * ```
 */
export const useModel = (src: string, props: Record<string, unknown> = {}): AssetResult =>
 ...
 * ```
 */
export const useFont = (src: string, props: Record<string, unknown> = {}): AssetResult => useAsset(src, 'font', props);
