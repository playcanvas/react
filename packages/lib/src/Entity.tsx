 ...
 */
export const Entity = forwardRef<PcEntity, EntityProps>(function Entity(props, ref): React.ReactElement | null {
    ...
    return (
        <>
            <ParentContext.Provider value={entity}>{children || null}</ParentContext.Provider>
        </>
    );
});
