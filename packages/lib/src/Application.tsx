...
export const Application: React.FC<ApplicationProps> = ({
    ...
    return (
        <>
            <Canvas className={className} style={style} ref={canvasRef} />
...
const Canvas = React.memo(
    React.forwardRef<HTMLCanvasElement, CanvasProps>((props: CanvasProps, ref) => {
        ...
        <PhysicsProvider enabled={usePhysics} app={app}>
            <AppContext.Provider value={appRef.current}>
                <PointerEventsContext.Provider value={pointerEvents}>
                    <ParentContext.Provider value={appRef.current?.root as PcEntity}>{children}</ParentContext.Provider>
...
interface ApplicationProps
    extends Omit<Partial<PublicProps<PlayCanvasApplication>>, ExcludedApplicationProps>, CanvasProps {
    /**
