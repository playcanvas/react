...
// interface ApplicationProps extends ApplicationWithoutCanvasProps {
...
export default {
    type: 'application',
    createInstance: (type: string, props: ApplicationWithoutCanvasProps, rootContainerInstance: any, hostContext: any, internalHandle: any) => {

        if (type !== 'application') throw new Error(`Invalid type: "${type}"`);
        ...
        const app = new PlayCanvasApplication(canvas, {
            mouse: new Mouse(canvas),
            touch: new TouchDevice(canvas),
            graphicsDeviceOptions
        });
